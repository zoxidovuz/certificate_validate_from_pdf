        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="vat" name="vat" value="{{ old('vat') ?? $certificate->vat  }}" required>
                </div>
            </div>
            <div class="col-md-12">
                <div class="form-group">
                    <label for="society">{{ __('Society') }}</label>
                    <textarea rows="6" class="form-control" name="name_society" id="society">{{ old('name_society') ?? $certificate->name_society }}</textarea>
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class=" input-group">
                    <select name="type" id="type" class="form-control">
                        <option value="1" {{ $certificate->type === 1 ? 'selected' : ''}}>Type 1</option>
                        <option value="2" {{ $certificate->type === 2 ? 'selected' : ''}}>Type 2</option>
                        <option value="3" {{ $certificate->type === 3 ? 'selected' : ''}}>Type 3</option>
                    </select>
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class=" input-group input-daterange">
                    <input type="text" id="date_certificate" name="date_certificate" value="{{ old('date_certificate') ?? $certificate->date_certificate }}"
